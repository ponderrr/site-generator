...
import type { CacheEntry, CacheStats, DeepPartial } from "../types/index.js";
...
export {
  CacheKeyGenerator,
  analysisCacheKeyGenerator,
  apiCacheKeyGenerator,
  sessionCacheKeyGenerator,
  CacheKeyUtils,
} from "./key-generator.js";
export type { CacheKeyOptions, CacheKeyData } from "./key-generator.js";

// Global cache instances
export const defaultCache = new EnhancedLRUCache();
export const analysisCache = new EnhancedLRUCache({
  maxSize: 5000,
  ttl: 1000 * 60 * 30,
}); // 30 minutes
export const extractionCache = new EnhancedLRUCache({
  maxSize: 2000,
  ttl: 1000 * 60 * 60,
}); // 1 hour
export const generationCache = new EnhancedLRUCache({
  maxSize: 1000,
  ttl: 1000 * 60 * 15,
}); // 15 minutes
