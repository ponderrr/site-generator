@echo off
echo 🚀 Starting Automatic Site Generator (Fixed Version)...
...
echo.
echo 🤖 Step 3: Generating business content with images (Simple Generator)...
py scripts/generate-simple-content.py
if %errorlevel% neq 0 (
